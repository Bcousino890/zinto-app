...
const useStyles = makeStyles((theme) => ({
  ...
  imageSide: {
    flex: 1,
    background: `url('https://lp-one.tappy.id/wp-content/uploads/2025/07/fundo-branco-3.png') no-repeat center center`,
  ...
  useEffect(() => {
    const fetchUserCreationStatus = async () => {
      try {
        ...
        console.error("Error al verificar userCreation:", err);
    ...
    <>
      ...
      <div className={classes.root}>
        ...
        <div
          ...
          onClick={() => window.open("https://wa.me/56991653343")}
        >
          <img
